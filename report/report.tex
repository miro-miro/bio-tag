...
\begin{center}
  \begin{tikzpicture}
    \node[mytext] (seq) {
      \ttfamily 5-ACCTACCTCAAGCAAG-3\\
      \ttfamily 3-\ \ \ \ TGGAGTTCGT\ \ -5
    };
  \end{tikzpicture}
\end{center}
...
\begin{center}
  \begin{tikzpicture}
    ...
    \node[mytext, right=of prodX] {
      \ttfamily 5-AGGT\textcolor{magenta}{N}\textcolor{cyan}{CATCC}\textcolor{blue}{GGCGGA}\textcolor{magenta}{(N)}TGGASS-3\\
      \ttfamily 3-\ \ \ \ \textcolor{magenta}{N}\textcolor{cyan}{GTAGG}\textcolor{blue}{CCGCCT}\textcolor{magenta}{(N)}ACCT\ \ -5
    };
    \node[mytext, below=of prodX] (prodY) {Y $\to$ YZ:};
    \node[mytext, right=of prodY] {
      \ttfamily 5-CTTG\textcolor{magenta}{N}\textcolor{cyan}{CATCC}\textcolor{blue}{GGCGGA}\textcolor{magenta}{(N)}GTTCAGCTSS-3\\
      \ttfamily 3-\ \ \ \ \textcolor{magenta}{N}\textcolor{cyan}{GTAGG}\textcolor{blue}{CCGCCT}\textcolor{magenta}{(N)}CAAGTCGA\ \ -5
    };
    \node[mytext, below=of prodY] (prodZ) {Z $\to$ ZZ:};
    \node[mytext, right=of prodZ] {
      \ttfamily 5-TCGA\textcolor{magenta}{N}\textcolor{cyan}{CATCC}\textcolor{blue}{GGCGGA}\textcolor{magenta}{(N)}AGCTAGCTSS-3\\
      \ttfamily 3-\ \ \ \ \textcolor{magenta}{N}\textcolor{cyan}{GTAGG}\textcolor{blue}{CCGCCT}\textcolor{magenta}{(N)}TCGATCGA\ \ -5
    };
  \end{tikzpicture}
\end{center}
