...
last we have a buffer of one nt and a target sequence for BsaI (GAGACC), which
...
To conclude the report here are some of the problems we were unable to solve.
